// UK SIC 2007 — comprehensive lookup of all sections A-U.
// Source: ONS UK SIC 2007 Standard Industrial Classification of Economic Activities.
//
// 5-digit codes used by Companies House, organised by section:
...
//   K 64-66  Financial and Insurance
//   L 68     Real Estate
//   M 69-75  Professional, Scientific, Technical
//   N 77-82  Administrative and Support
...
//   U 99     Activities of Extraterritorial Organisations
...
const SIC = {
  ...
  '46439': 'Wholesale of radio, television goods & electrical household appliances (other than records, tapes, CDs & video tapes and the equipment used for playing them)',
  ...
  '47599': 'Retail sale of furniture, lighting equipment and other household articles n.e.c. in specialised stores',
  ...
  '47761': 'Retail sale of flowers, plants, seeds and fertilizers in specialised stores',
  '47762': 'Retail sale of pet animals and pet food in specialised stores',
  '47770': 'Retail sale of watches and jewellery in specialised stores',
  '47781': 'Retail sale in commercial art galleries',
  '47782': 'Retail sale by opticians',
  '47789': 'Other retail sale of new goods in specialised stores (other than by opticians or commercial art galleries)',
  ...
  '77352': 'Renting and leasing of air freight transport equipment',
  ...
  '93199': 'Other sports activities (not incl. activities of racehorse owners)',
...
const DIVISIONS = {
  '01': 'Agriculture, forestry and fishing — Crop and animal production, hunting',
  ...
  59: 'Motion picture, video, TV programme production and music publishing',
...
export function describeSic(code) {
  ...
  if (DIVISIONS[division]) {
    return `${DIVISIONS[division]} — specific code ${key}`;
  }
  return `SIC ${key} (uncategorised)`;
}
